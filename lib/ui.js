...
function displayArrivals ( mode, showTerm, countdowns )
{
  ...
  case "dest":
    ...
    if (masstrac.arrSorted.red.a.length > 0 ||
      ...
      arrCont += "<li class='destination'>Destination: Ashmont</li><ul>";
      ...
      arrCont += "<li class='destination'>Destination: Braintree</li><ul>";
      ...
      arrCont += "<li class='destination'>Destination: Alewife</li><ul>";
    ...
    if (masstrac.arrSorted.orange.f.length > 0 ||
      ...
      arrCont += "<li class='destination'>Destination: Forest Hills</li><ul>";
      ...
      arrCont += "<li class='destination'>Destination: Oak Grove</li><ul>";
    ...
    if (masstrac.arrSorted.blue.b.length > 0 ||
      ...
      arrCont += "<li class='destination'>Destination: Bowdoin</li><ul>";
      ...
      arrCont += "<li class='destination'>Destination: Wonderland</li><ul>";
    ...
    if (masstrac.arrSorted.cr.inb.length > 0 ||
       ...
       */
      if (masstrac.arrSorted.cr.inb.length > 0) {
        arrCont += "<li class='destination'>Destination: " + 

 ...
 * Author: Daniel Brook
 * 
 * Last Updated: 2013-04-23 at  6:15 PM
 * 
 ...
 * 
 * ^^^^^ As of 25-Apr-2013, this situation was resolved according to the
 * discussion on the MassDOT Developers Group on Google Groups! Now the
 * Haverhill parts of these trips appear on the Haverhill Line JSON, and the
 * Lowell parts in the Lowell Line JSON. The same goes for Fairmount/Franklin.
 * The result of this is that we now no longer need to maintain the convoluted
 * system of extending the Fairmount line svcs[] entries all the way to 
 * Forge Park (and the Haverhill Line onto the entire Lowell Line). This also
 * makes it MUCH easier for users to see everything at a stop like these 
 * without having to fetch multiple JSONs to handle the 2 or 3 trains per day
 * that could stop there.
 */
...
masstrac.stations =
    ...
    [
        ...
        {
            name : "North Station",
            svcs : ["green", "orange", "fitchburg", "haverhill", "newb_rock", "lowell"],
            bus : [4],
            lat : 42.365577,
            lon : -71.06129,
            orangeMap : {
        ...
        {
            name : "South Station",
            svcs : ["red", "needham", "prov_stough", "worcester", "franklin", "king_plym", "middleborough", "greenbush" ,"fairmount"],

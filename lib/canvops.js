 ...
 * 
 * Last Updated by Daniel Brook on 2013-04-20 at _____ PM
 * 
...
canvops.basemap = function ( name, line )
{
  ...
  switch (line) {
    ...
    case "orange":
      ...
      cxt = c.getContext( '2d' );
      //cxt.rect(staObj.orangeMap.sta - canvops.rectH / 2, 
      //         staObj.orangeMap.sta - canvops.rectW / 2, 

...
masstrac.sortArrivals = function( mode )
{
  ...
  case "dest":
    // Do a time-based sort first
    masstrac.arrivals.sort(SortByArrivalTime);
   
    // Make a staging area to hold each arrival object while it's sorted
    // Why can't we sort the easy way (just making another comparator func)?
    // Browser's don't guarantee stable sorts (meaning that on an equivalent
    // sort key, the original order is NOT preserved.
    
    masstrac.tempArr = new Object();
    masstrac.tempArr.red = new Object();
    masstrac.tempArr.red.a = new Array();       // Ashmont Trains
    masstrac.tempArr.red.b = new Array();       // Braintree Trains
    masstrac.tempArr.red.c = new Array();       // Alewife Trains
    masstrac.tempArr.red.z = new Array();       // Other destinations
    masstrac.tempArr.orange = new Object();
    masstrac.tempArr.orange.o = new Array();    // Oak Grove Trains
    masstrac.tempArr.orange.f = new Array();    // Forest Hills Trains
    masstrac.tempArr.orange.z = new Array();    // Other destinations
    masstrac.tempArr.blue = new Object();
    masstrac.tempArr.blue.b = new Array();      // Bowdoin / Gov't Center Trains
    masstrac.tempArr.blue.w = new Array();      // Wonderland Trains
    masstrac.tempArr.blue.z = new Array();      // Other destinations
    masstrac.tempArr.cr = new Object();
    masstrac.tempArr.cr.inbound = new Array();  // Trains towards Boston
    masstrac.tempArr.cr.outbound = new Array(); // Trains away from Boston
    
    masstrac.tempArr.despair = new Object();    // Unexpected Route Area
      ...
      switch (arrObj.Line) {
        case "red":
          if (arrObj.Destination == "Ashmont")
            masstrac.tempArr.red.a.push( arrObj );
          else if (arrObj.Destination == "Braintree")
            masstrac.tempArr.red.b.push( arrObj );
          else if (arrObj.Destination == "Alewife")
            masstrac.tempArr.red.c.push( arrObj );
          else
            masstrac.tempArr.red.z.push( arrObj );
          break;
          
        case "orange":
          if (arrObj.Destination == "Oak Grove")
            masstrac.tempArr.orange.o.push( arrObj );
          else if (arrObj.Destination == "Forest Hills")
            masstrac.tempArr.orange.f.push( arrObj );
          else
            masstrac.tempArr.orange.z.push( arrObj );
          break;
          
        case "blue":
          if (arrObj.Destination == "Bowdoin")
            masstrac.tempArr.blue.b.push( arrObj );
          else if (arrObj.Destination == "Wonderland")
            masstrac.tempArr.blue.w.push( arrObj );
          else
            masstrac.tempArr.blue.z.push( arrObj );
          break;
        ...
        case "franklin":
          if (arrObj.Destination == "North Station" ||
            ...
            masstrac.tempArr.cr.inbound.push( arrObj );
          else
            masstrac.tempArr.cr.outbound.push( arrObj );
          break;
          
        default:
          masstrac.tempArr.despair.push( masstrac.arrivals[entry] );
      }
    }
    
    // Each Line has been isolated. Now pop them back into masstrac.arrivals
    // to sort them as desired. There's probably a better way to do this.
    // 
    delete masstrac.arrivals;
    masstrac.arrivals = new Array();
    
    while (masstrac.tempArr.red.a.length > 0)
      masstrac.arrivals.push( masstrac.tempArr.red.a.shift() );
    while (masstrac.tempArr.red.b.length > 0)
      masstrac.arrivals.push( masstrac.tempArr.red.b.shift() );
    while (masstrac.tempArr.red.c.length > 0)
      masstrac.arrivals.push( masstrac.tempArr.red.c.shift() );
    while (masstrac.tempArr.red.z.length > 0)
      masstrac.arrivals.push( masstrac.tempArr.red.z.shift() );

    while (masstrac.tempArr.orange.f.length > 0)
      masstrac.arrivals.push( masstrac.tempArr.orange.f.shift() );
    while (masstrac.tempArr.orange.o.length > 0)
      masstrac.arrivals.push( masstrac.tempArr.orange.o.shift() );
    while (masstrac.tempArr.orange.z.length > 0)
      masstrac.arrivals.push( masstrac.tempArr.orange.z.shift() );

    while (masstrac.tempArr.blue.b.length > 0)
      masstrac.arrivals.push( masstrac.tempArr.blue.b.shift() );
    while (masstrac.tempArr.blue.w.length > 0)
      masstrac.arrivals.push( masstrac.tempArr.blue.w.shift() );
    while (masstrac.tempArr.blue.z.length > 0)
      masstrac.arrivals.push( masstrac.tempArr.blue.z.shift() );
    
    while (masstrac.tempArr.cr.inbound.length > 0)
      masstrac.arrivals.push( masstrac.tempArr.cr.inbound.shift() );
    while (masstrac.tempArr.cr.outbound.length > 0)
      masstrac.arrivals.push( masstrac.tempArr.cr.outbound.shift() );
    
    while (masstrac.tempArr.despair.length > 0)
      masstrac.arrivals.push( masstrac.tempArr.despair.shift() );

    // Probably overkill but it's worth being safe
    delete masstrac.tempArr;
    break;

...
masstrac.sortArrivals = function( mode )
{
  ...
  case "dest":
     ...
     * 
     * Since the user has likely chosen this option for simplicity, any trips 
     * with weird destination data are *******simply omitted*******.
     */
      ...
      switch (arrObj.Line) {
        ...
        case "franklin":
          if (arrObj.Destination == "North Station" ||
            ...
            masstrac.arrSorted.cr.inbound.push( arrObj );
          else
            masstrac.arrSorted.cr.outbound.push( arrObj );
          break;

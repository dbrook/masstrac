    ...
    if (pred.Stop == stop_name ) {
      ...
      case "pre":
        detail = {
          ...
          "TripID"      : pred.Trip,
          "Destination" : pred.Destination,
          "Note"        : "Train #" + pred.Trip + " - Operating",
          "Type"        : "pre",
      ...
      case "app":
        detail = {
          ...
          "Type"        : "app",
          "Countdown"   : 120,    // Forced to 2min to avoid the negative times
                                  // and to bring in line with Subway predictions.
          "UNIXtime"    : (1 * pred.Scheduled + 1 * pred.Lateness),
          "lat"         : pred.Latitude,
          "lon"         : pred.Longitude
        };
      ...
      case "arr":
        detail = {
          ...
          "Type"        : "arr",
          "Countdown"   : 60,  // Forced to 1min to avoid the negative times
                               // and to bring in line with Subway predictions.
          "UNIXtime"    : (1 * pred.Scheduled + 1 * pred.Lateness),
          "lat"         : pred.Latitude,
          "lon"         : pred.Longitude
      ...
      case "dep":
        detail = {
          ...
          "Type"        : "dep",
          "Countdown"   : 0,   // Forced to 0 min to avoid the negative times
                               // and to bring in line with Subway predictions.
          "UNIXtime"    : (1 * pred.Scheduled + 1 * pred.Lateness),
          "lat"         : pred.Latitude,
          "lon"         : pred.Longitude
